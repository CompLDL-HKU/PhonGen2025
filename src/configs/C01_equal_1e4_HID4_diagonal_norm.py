...
CSV_PATH = '/mnt/storage/ldl_linguistics/PhonGen2025_diag_new/data/data_train_unequal/metadata_train_equal.csv'
# CSV_PATH2 = '/mnt/storage/ldl_linguistics/PhonGen2025/data_251011/data_train_phase2_a/metadata_train_phase2_a.csv'
CSV_PATH3 = '/mnt/storage/ldl_linguistics/PhonGen2025_diag_new/data/data_test_unequal/metadata_test_equal.csv'
DEVICE = 'cuda'
OUT_FEATURES = 4
TEMPERATURE = 0.07
MINMAX = True

...
def main(config_path, run_name=None):
    ...
    eval_save_dir_hyper = os.path.join(config.WRITE_BASE_PATH, 'eval_outputs', config.RUN_NAME)
...
if __name__ == '__main__':
    ...
    for run_name in pre_load_config.RUN_NAMES:
        main(args.config, run_name=run_name)